...
const Header = () => {
    ...
    return(
        ...
        <div className="bg-orange-600 flex w-full">
            <div className="bg-orange-600 flex items-center pl-5 text-white w-1/2">
                <img src={foodvista_logo} className="h-10 w-10" />
            </div>
            <div className="bg-orange-600 flex justify-center w-1/2">
            ...
            {
                isLoggedIn ? <button onClick={()=>setIsLoggedIn(false)} className="bg-white text-orange-600 p-3 border-2 border-orange-600">Logout</button> : <button onClick={()=>setIsLoggedIn(true)} className="bg-white text-orange-600 p-3 border-2 border-orange-600">Login</button> 
            }
